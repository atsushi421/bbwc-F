...
from .views import signup, activate, index, chat, room_list, profile_edit, file_list, profile, create_room
...
urlpatterns = [
    ...
    path('profile_edit/<int:pk>', profile_edit.ProfileEditView.as_view(), name='profile_edit'),
    ...
    path('create_room/', create_room.CreateRoomView.as_view(), name='create_room'),
